...
if len(list2) != 1:
    ...
    for j in list1:  # here i created a condition where all unique keys
        if j not in d:
            d[j] = 1
        else:  # get value 1 and when a key repeats it increases
...
print(alist_sid)
sorted_student_info_sid = dict(alist_sid)
